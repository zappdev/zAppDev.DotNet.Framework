use master
if exists (select * from sys.databases where name='ClmsFrameworkSampleDB')
   drop database ClmsFrameworkSampleDB
   create database ClmsFrameworkSampleDB
GO

use ClmsFrameworkSampleDB
