...
namespace zAppDev.DotNet.Framework.Mvc
{
    public class RuntimePredicateBuilder
    {
        ...
        private static string GenerateOrderByCode<T>(List<OrderByInfo> orderBy)
        {
            ...
            var code = $@"public static List<zAppDev.DotNet.Framework.Mvc.DynamicOrderBy<{TypeName(type)}>> BuildOrderByList() {{
                            var list = new List<zAppDev.DotNet.Framework.Mvc.DynamicOrderBy<{TypeName(type)}>>();";
            ...
            foreach (var order in orderBy)
            {
                ...
                code += $"list.Add(new zAppDev.DotNet.Framework.Mvc.DynamicOrderBy<{TypeName(type)}>(\"{order.Column.Name}\", o => {expressionToUse}, {ascending}));";
            }
        ...
        private static string GenerateGroupByCode<T>(List<GroupByInfo> groupBy)
        {
            ...
            var code = $@"public static List<zAppDev.DotNet.Framework.Mvc.DynamicGroupBy<{TypeName(type)}>> BuildGroupByList() {{
                            var list = new List<zAppDev.DotNet.Framework.Mvc.DynamicGroupBy<{TypeName(type)}>>();";
            ...
            foreach (var group in groupBy)
            {
                ...
                code += $"list.Add(new zAppDev.DotNet.Framework.Mvc.DynamicGroupBy<{TypeName(type)}>(\"{group.Column.Name}\", o => {safecasePathToProp}, {expanded}));";
            }
        ...
        private static string GenerateAggregatorsCode<T>(List<AggregatorInfo<T>> aggregators)
        {
            ...
            var code =
                $"public static List<zAppDev.DotNet.Framework.Mvc.AggregatorInfo<{TypeName(type)}>> BuildAggregatorPredicates(List<zAppDev.DotNet.Framework.Mvc.AggregatorInfo<{TypeName(type)}>> aggregators)  {{";
        ...
        private static string GenerateClosedGroupsCode<T>(List<GroupByInfo> groupBy, List<AggregatorInfo<T>> aggregators)
        {
            ...
            var code = $@"public static zAppDev.DotNet.Framework.Mvc.DynamicClosedGroupsInfo<{TypeName(type)}> BuildClosedGroupsInfo() {{
                            var closedGroupsInfo = new zAppDev.DotNet.Framework.Mvc.DynamicClosedGroupsInfo<{TypeName(type)}>();
                            var groups = new List<zAppDev.DotNet.Framework.LinqRuntimeTypeBuilder.FieldDefinition<{TypeName(type)}>>();";
            ...
            code += $@"var selectors = new List<zAppDev.DotNet.Framework.LinqRuntimeTypeBuilder.FieldDefinition<IGrouping<object, {TypeName(type)}>>>();
                       selectors.Add(new zAppDev.DotNet.Framework.LinqRuntimeTypeBuilder.FieldDefinition<IGrouping<object, {TypeName(type)}>>
                       {{
                            Name = ""Key"",
            ...
            foreach (var entry in aggregators)
            {
                ...
                code += $@"selectors.Add(new zAppDev.DotNet.Framework.LinqRuntimeTypeBuilder.FieldDefinition<IGrouping<object, {TypeName(type)}>>
                           {{
            ...
            code += $@"Type groupAnonType, selectorAnonType;
                       var expressions = zAppDev.DotNet.Framework.LinqRuntimeTypeBuilder.LinqRuntimeTypeBuilder.CreateGroupByAndSelectExpressions<{TypeName(type)}>(groups, selectors, out groupAnonType, out selectorAnonType);
