...
namespace CLMS.Framework.Auditing.Model
{
    ...
    [Serializable]
    [DataContract]
    public class AuditLogEntryType : DomainModel
    {
        /// <summary>
        /// The Id property
        ///
        ...
        public new virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new CLMS.Framework.Exceptions.BusinessException("An instance of TypeClass 'AuditLogEntryType' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
