...
namespace cfTests.Web.Code.WebApi
{
    ...
    public class RedisRateTableThrottling : IExternalRateTable
    {
        ...
        {
            return CLMS.Framework.Utilities.ApplicationCache.Get<List<ExternalTableRateEnrty>>(GetRequestKey(request, identity))?.FirstOrDefault();
        }
